...
public class CommonConfig
{
    ...
    public static final ForgeConfigSpec.BooleanValue GENERATE_ENDER_ORE;
    public static final ForgeConfigSpec.BooleanValue GENERATE_THALLASIUM_ORE;
    ...
    static
    {
        ...
        BUILDER.comment("\nEnable/disable generation of Ender Ore.\nDefault value: true");
        GENERATE_ENDER_ORE = BUILDER.define("enderOreEnabled", true);

        BUILDER.comment("\nEnable/disable generation of Thallasium Ore.\nDefault value: true");
        GENERATE_THALLASIUM_ORE = BUILDER.define("thallasiumOreEnabled", false);
    ...
    public static boolean shouldGnereateEnderOre() {
        return GENERATE_ENDER_ORE.get();
    }

    public static boolean shouldGenerateThallasiumOre() {
        return GENERATE_THALLASIUM_ORE.get();
    }
