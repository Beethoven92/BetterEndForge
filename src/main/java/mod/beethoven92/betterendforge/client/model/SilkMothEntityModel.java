...
public class SilkMothEntityModel extends BlockBenchModel<SilkMothEntity> {
	...
	public void setupAnim(SilkMothEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
		wingR_r1.zRot = MathHelper.sin(animationProgress * 2F) * 0.4F + 0.3927F;
		wingL_r1.zRot = -wingR_r1.zRot;
		head_pivot.xRot = MathHelper.sin(animationProgress * 0.03F) * 0.1F;
		tendril_r_r1.zRot = MathHelper.sin(animationProgress * 0.07F) * 0.2F + 0.3927F;
		tendril_r_r2.zRot = -tendril_r_r1.zRot;
		abdomen_r1.xRot = MathHelper.sin(animationProgress * 0.05F) * 0.1F - 0.3927F;
		legsR.zRot = MathHelper.sin(animationProgress * 0.07F) * 0.1F - 0.6545F;
