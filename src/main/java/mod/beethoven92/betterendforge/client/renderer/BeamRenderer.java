...
public class BeamRenderer 
{
	...
	public static void renderLightBeam(PoseStack matrices, MultiBufferSource bufferIn, int age, float tick, 
			int minY, int maxY, float[] colors, float alpha, float beamIn, float beamOut) 
	{
		...
		VertexConsumer iVertexBuilder = bufferIn.getBuffer(RenderType.beaconBeam(BEAM_TEXTURE, true));
	...
	private static void renderBeam(PoseStack matrices, VertexConsumer vertexBuilder, float red, float green, float blue, float alpha, int minY, int maxY, float x1, float d1, float x2, float d2, float x3, float d3, float x4, float d4, float minU, float maxU, float minV, float maxV)
	{
	...
	private static void renderBeam(Matrix4f matrix4f, Matrix3f matrix3f, VertexConsumer vertexBuilder, float red, float green, float blue, float alpha, int minY, int maxY, float minX, float minD, float maxX, float maxD, float minU, float maxU, float minV, float maxV) 
	{
	...
	private static void addVertex(Matrix4f matrix4f, Matrix3f matrix3f, VertexConsumer vertexBuilder, float red, float green, float blue, float alpha, float x, float y, float d, float u, float v) 
	{
