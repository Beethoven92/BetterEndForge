...
public class AmberLandBiome extends BetterEndBiome {
	public AmberLandBiome() {
		super(new BiomeTemplate("amber_land")
				...
				.setFogDensity(2.0F)
				.setFogColor(219, 115, 38)
				.setWaterFogColor(145, 108, 72)
				.setMusic(ModSoundEvents.MUSIC_AMBER_LAND.get())
				.setParticles(ModParticleTypes.AMBER_SPHERE.get(), 0.001F)
				.setSurface(ModBlocks.AMBER_MOSS.get())
				.addFeature(Decoration.VEGETAL_DECORATION, ModConfiguredFeatures.AMBER_ORE)
				.addFeature(Decoration.VEGETAL_DECORATION, ModConfiguredFeatures.END_LAKE_RARE)
